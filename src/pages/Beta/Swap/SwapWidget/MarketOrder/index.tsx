...
import { Token, Trade, JSBI, CurrencyAmount, TokenAmount } from 'pizzaswap-sdk'
...
import { COIN_LIST } from 'src/constants/lists'
...
const MarketOrder: React.FC<Props> = ({ swapType, setSwapType }) => {
  ...
  const whitelistedTokens = useTokenList([COIN_LIST])
